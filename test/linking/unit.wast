...
(component
  ...
  (func (export "get-a") (result string)
    (canon lift (core func $a "get") (memory $a "mem")))
  (func (export "get-b") (result string)
    (canon lift (core func $b "get") (memory $b "mem")))
)
...
(component
  ...
  (func (export "get") (result string)
    (canon lift (core func $m "get") (memory $p "mem")))
)
...
(component
  (component $Def
    ...
    (core instance $m (instantiate $M))
    (type $R1 (resource (rep i32) (dtor (func $m "dtor1"))))
    (type $R2 (resource (rep i32) (dtor (func $m "dtor2"))))
