...
(component definition $Tester
  (component $C
    ...
    (type $R (resource (rep i32) (dtor (core func $cm "unblocker"))))
    (type $S (resource (rep i32) (dtor (core func $cm "poker"))))
    ...
    (func (export "blocker-cb") async (result u32) (canon lift (core func $cm "blocker-cb") async (callback (core func $cm "blocker-cb-cb"))))
    ...
    (func (export "yielder-cb") async (result u32) (canon lift (core func $cm "yielder-cb") async (callback (core func $cm "yielder-cb-cb"))))
  ...
  (component $D
    ...
    (canon lower (func $c "blocker") (memory (core memory $memory "mem")) async (core func $blocker'))
    (canon lower (func $c "blocker-cb") (memory (core memory $memory "mem")) async (core func $blocker-cb'))
    (canon lower (func $c "unblocker") (core func $unblocker'))
    (canon lower (func $c "new-S") (core func $new-S'))
    (canon lower (func $c "yielder") (memory (core memory $memory "mem")) async (core func $yielder'))
    (canon lower (func $c "yielder-cb") (memory (core memory $memory "mem")) async (core func $yielder-cb'))
