...
(assert_trap (invoke "trap-after-future-eager-write") "cannot write to future after previous write succeeded")
(component instance $i2 $Tester)
(assert_trap (invoke "trap-after-future-async-write") "cannot write to future after previous write succeeded")
(component instance $i3 $Tester)
(assert_trap (invoke "trap-after-future-reader-dropped") "cannot write to future after being notified that the readable end dropped")
