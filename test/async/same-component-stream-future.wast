...
(component definition $Tester
  ...
  (canon future.read $FTB async (memory (core memory $memory "mem")) (core func $future.readb))
  (canon future.write $FTB async (memory (core memory $memory "mem")) (core func $future.writeb))
  (canon stream.new $STB (core func $stream.newb))
  (canon stream.read $STB async (memory (core memory $memory "mem")) (core func $stream.readb))
  (canon stream.write $STB async (memory (core memory $memory "mem")) (core func $stream.writeb))
  (canon future.new $FTC (core func $future.newc))
  (canon future.read $FTC async (memory (core memory $memory "mem")) (core func $future.readc))
  (canon future.write $FTC async (memory (core memory $memory "mem")) (core func $future.writec))
