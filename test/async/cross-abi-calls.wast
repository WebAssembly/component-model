...
(component definition $C
  (component $Top
    ...
    (func (export "sync-17-param") async (param "a" u32) (param "b" u64) (param "c" f32) (param "d" f64)
    ...
    (func (export "async-4-param") async (param "a" u32) (param "b" u64) (param "c" f32) (param "d" f64)
      (canon lift (core func $core "async-4-param") async (callback (func $core "unreachable-cb")))
    )
    (func (export "async-5-param") async (param "a" u32) (param "b" u64) (param "c" f32) (param "d" f64) (param "e" u32)
      (canon lift (core func $core "async-5-param") async (callback (func $core "unreachable-cb")))
    )
    (func (export "async-17-param") async (param "a" u32) (param "b" u64) (param "c" f32) (param "d" f64)
                                    (param "e" u32) (param "f" u64) (param "g" f32) (param "h" f64)
                                    (param "i" u32) (param "j" u64) (param "k" f32) (param "l" f64)
                                    (param "m" u32) (param "n" u64) (param "o" f32) (param "p" f64)
                                    (param "q" u32)
  ...
  (component $Bottom
    ...
    (import "func-17-param" (func $func-17-param async (param "a" u32) (param "b" u64) (param "c" f32) (param "d" f64)
                                                 (param "e" u32) (param "f" u64) (param "g" f32) (param "h" f64)
                                                 (param "i" u32) (param "j" u64) (param "k" f32) (param "l" f64)
                                                 (param "m" u32) (param "n" u64) (param "o" f32) (param "p" f64)
                                                 (param "q" u32)))
...
;; The newer async typing/runtime rules no longer support the full sync/async
;; cross-product exercised here. Keep this as an instantiation smoke test.
