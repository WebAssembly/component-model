...
(component definition $C
  (component $Top
    ...
    (canon task.return (result (tuple u32 u64 f32 f64 u32 u64 f32 f64 u32 u64 f32 f64 u32 u64 f32 f64 u32)) (memory (core memory $memory "mem")) (core func $task.return17))
    ...
    (func (export "sync-17-param") async
                                   ...
                                   (param "q" u32)
      (canon lift (core func $core "sync-17-param") (memory (core memory $memory "mem")) (realloc (core func $memory "realloc")))
    )
    ...
    (func (export "sync-16-result") async (result (tuple u32 u64 f32 f64 u32 u64 f32 f64 u32 u64 f32 f64 u32 u64 f32 f64))
      (canon lift (core func $core "sync-16-result") (memory (core memory $memory "mem")))
    )
    (func (export "sync-17-result") async (result (tuple u32 u64 f32 f64 u32 u64 f32 f64 u32 u64 f32 f64 u32 u64 f32 f64 u32))
      (canon lift (core func $core "sync-17-result") (memory (core memory $memory "mem")))
    )
    (func (export "async-4-param") async
                                   (param "a" u32) (param "b" u64) (param "c" f32) (param "d" f64)
      (canon lift (core func $core "async-4-param") async (callback (core func $core "unreachable-cb")))
    )
    (func (export "async-5-param") async
                                   (param "a" u32) (param "b" u64) (param "c" f32) (param "d" f64) (param "e" u32)
      (canon lift (core func $core "async-5-param") async (callback (core func $core "unreachable-cb")))
    )
    (func (export "async-17-param") async
                                    ...
                                    (param "m" u32) (param "n" u64) (param "o" f32) (param "p" f64)
                                    (param "q" u32)
      (canon lift (core func $core "async-17-param") async (callback (core func $core "unreachable-cb")) (memory (core memory $memory "mem")) (realloc (core func $memory "realloc")))
    )
    (func (export "async-1-result") async (result f64)
      (canon lift (core func $core "async-1-result") async (callback (core func $core "unreachable-cb")))
    )
    (func (export "async-16-result") async (result (tuple u32 u64 f32 f64 u32 u64 f32 f64 u32 u64 f32 f64 u32 u64 f32 f64))
      (canon lift (core func $core "async-16-result") async (callback (core func $core "unreachable-cb")))
    )
    (func (export "async-17-result") async (result (tuple u32 u64 f32 f64 u32 u64 f32 f64 u32 u64 f32 f64 u32 u64 f32 f64 u32))
      (canon lift (core func $core "async-17-result") async (callback (core func $core "unreachable-cb")) (memory (core memory $memory "mem")) (realloc (core func $memory "realloc")))
    )
  )
  (component $Bottom
    ...
    (canon lower (func $func-4-param) async (memory (core memory $memory "mem")) (core func $async-4-param))
    (canon lower (func $func-5-param) (core func $sync-5-param))
    (canon lower (func $func-5-param) async (memory (core memory $memory "mem")) (core func $async-5-param))
    (canon lower (func $func-17-param) (memory (core memory $memory "mem")) (core func $sync-17-param))
    (canon lower (func $func-17-param) async (memory (core memory $memory "mem")) (core func $async-17-param))
    (canon lower (func $func-1-result) (core func $sync-1-result))
    (canon lower (func $func-1-result) async (memory (core memory $memory "mem")) (core func $async-1-result))
    (canon lower (func $func-16-result) (memory (core memory $memory "mem")) (core func $sync-16-result))
    (canon lower (func $func-16-result) async (memory (core memory $memory "mem")) (core func $async-16-result))
    (canon lower (func $func-17-result) (memory (core memory $memory "mem")) (core func $sync-17-result))
    (canon lower (func $func-17-result) async (memory (core memory $memory "mem")) (core func $async-17-result))
    (core instance $core (instantiate $Core (with "" (instance
      (export "mem" (memory $memory "mem"))
