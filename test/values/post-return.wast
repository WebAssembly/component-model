...
(component definition $Tester
  ...
  (component $D
    ...
    (core module $DM
      ...
      (func (export "trap-calling-thread-index") (drop (call $thread.index)))
      (func (export "trap-calling-thread-get-task") (drop (call $thread.get-task)))
      (func (export "trap-calling-thread-set-task") (call $thread.set-task (i32.const 1)))
      (func (export "trap-calling-task-drop") (call $task.drop (i32.const 1)))
      ...
      (func (export "trap-calling-stream-forward") (call $stream.forward (i32.const 0) (i32.const 0)))
      ...
      (func (export "trap-calling-future-forward") (call $future.forward (i32.const 0) (i32.const 0)))
    )
    ...
    (func (export "trap-calling-import") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-import"))))
    (func (export "trap-calling-resource-new") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-resource-new"))))
    (func (export "trap-calling-resource-drop") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-resource-drop"))))
    (func (export "trap-calling-task-return") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-task-return"))))
    (func (export "trap-calling-task-cancel") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-task-cancel"))))
    (func (export "trap-calling-yield") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-yield"))))
    (func (export "trap-calling-thread-index") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-thread-index"))))
    (func (export "trap-calling-thread-get-task") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-thread-get-task"))))
    (func (export "trap-calling-thread-set-task") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-thread-set-task"))))
    (func (export "trap-calling-task-drop") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-task-drop"))))
    (func (export "trap-calling-waitable-set-new") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-waitable-set-new"))))
    (func (export "trap-calling-waitable-set-wait") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-waitable-set-wait"))))
    (func (export "trap-calling-waitable-set-poll") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-waitable-set-poll"))))
    (func (export "trap-calling-waitable-set-drop") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-waitable-set-drop"))))
    (func (export "trap-calling-waitable-join") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-waitable-join"))))
    (func (export "trap-calling-subtask-cancel") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-subtask-cancel"))))
    (func (export "trap-calling-subtask-drop") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-subtask-drop"))))
    (func (export "trap-calling-stream-new") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-stream-new"))))
    (func (export "trap-calling-stream-read") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-stream-read"))))
    (func (export "trap-calling-stream-write") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-stream-write"))))
    (func (export "trap-calling-stream-cancel-read") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-stream-cancel-read"))))
    (func (export "trap-calling-stream-cancel-write") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-stream-cancel-write"))))
    (func (export "trap-calling-stream-drop-readable") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-stream-drop-readable"))))
    (func (export "trap-calling-stream-drop-writable") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-stream-drop-writable"))))
    (func (export "trap-calling-stream-forward") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-stream-forward"))))
    (func (export "trap-calling-future-new") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-future-new"))))
    (func (export "trap-calling-future-read") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-future-read"))))
    (func (export "trap-calling-future-write") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-future-write"))))
    (func (export "trap-calling-future-cancel-read") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-future-cancel-read"))))
    (func (export "trap-calling-future-cancel-write") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-future-cancel-write"))))
    (func (export "trap-calling-future-drop-readable") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-future-drop-readable"))))
    (func (export "trap-calling-future-drop-writable") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-future-drop-writable"))))
    (func (export "trap-calling-future-forward") (canon lift (core func $dm "noop") (post-return (core func $dm "trap-calling-future-forward"))))
  )
  ...
  (func (export "trap-calling-thread-index") (alias export $d "trap-calling-thread-index"))
  (func (export "trap-calling-thread-get-task") (alias export $d "trap-calling-thread-get-task"))
  (func (export "trap-calling-thread-set-task") (alias export $d "trap-calling-thread-set-task"))
  (func (export "trap-calling-task-drop") (alias export $d "trap-calling-task-drop"))
  ...
  (func (export "trap-calling-stream-forward") (alias export $d "trap-calling-stream-forward"))
  ...
  (func (export "trap-calling-future-forward") (alias export $d "trap-calling-future-forward"))
)
...
(assert_trap (invoke "trap-calling-thread-index") "cannot leave component instance")
...
(component instance $i28 $Tester)
(assert_trap (invoke "trap-calling-stream-forward") "cannot leave component instance")
(component instance $i29 $Tester)
(assert_trap (invoke "trap-calling-future-forward") "cannot leave component instance")
(component instance $i30 $Tester)
(assert_trap (invoke "trap-calling-thread-get-task") "cannot leave component instance")
(component instance $i31 $Tester)
(assert_trap (invoke "trap-calling-thread-set-task") "cannot leave component instance")
(component instance $i32 $Tester)
(assert_trap (invoke "trap-calling-task-drop") "cannot leave component instance")
