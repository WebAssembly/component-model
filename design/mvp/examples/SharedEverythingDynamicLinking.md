...
(component
  ...
  (instance $zipper (instantiate (component $Zipper)
    (arg "libc" (module $Libc))
    (arg "libzip" (module $Libzip))
  ))
  (instance $imgmgk (instantiate (component $Imgmgk)
    (arg "libc" (module $Libc))
    (arg "libzip" (module $Libzip))
    (arg "libimg" (module $Libimg))
  ))
  ...
  (instance $main (instantiate (module $Main)
    (arg "libc" (instance $libc))
    (arg "zipper" (instance (export "zip" (func $zipper "zip"))))
    (arg "imgmgk" (instance (export "transform" (func $imgmgk "transform"))))
  ))
  (func (export "run")
