...
defvaltype    ::= pvt:<primvaltype>                       => pvt
                ...
                | 0x6e l*:vec(<labelname>)                => (flags l+)    (if 0 < |l*| <= 32)
                | 0x6d l*:vec(<labelname>)                => (enum l+)     (if |l*| > 0)
...
labelvaltype  ::= l:<labelname> t:<valtype>               => l t
case          ::= l:<labelname> t?:<valtype>? 0x00        => (case l t?)
labelname     ::= len:<u32> l:<label>                     => "l"  (if len = |l|)
<T>?          ::= 0x00                                    =>
                | 0x01 t:<T>                              => t
valtype       ::= i:<typeidx>                             => i
                | pvt:<primvaltype>                       => pvt
