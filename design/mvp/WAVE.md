...
> **Note**: WAVE is an in-progress specification that does not currently support
> all possible component model values. Whether or not this continues to live
> here in the component-model repo long-term, how it integrates with other parts
> of the component model, and what the long-term fate of WAVE are still areas of
> active discussion. Nevertheless this is intended to be an interoperable and
> "default" way of stringifying component model values, hence the current
> location for this document in the component-model repository.
